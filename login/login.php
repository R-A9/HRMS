...
<body>
      ...
      <form class="p-3 rounded" action="generate-otp.php" method="post" style="width: 500px;">
    ...
    <center><p class="pt-4">Going back to main page? Click <a href="../hrms-inner/main-page.html">here</a></p></center>
</form>
